...
function useFilters() {
  ...
  return { searchParams, pushParams, toggle, removeOne, clearAll, checked };
}
...
function FilterPanel() {
  const { searchParams, pushParams, toggle, clearAll, checked } = useFilters();
...
/** Desktop sticky sidebar (hidden below lg — mobile uses the drawer). */
  ...
  return (
    <div className="lg:hidden">
      ...
      <div
        ...
        className={`fixed inset-y-0 right-0 z-[150] flex w-[88%] max-w-[380px] flex-col bg-bg shadow-xl transition-transform duration-[380ms] ease-out-soft ${
